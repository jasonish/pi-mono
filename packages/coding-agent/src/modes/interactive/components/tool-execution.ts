...
export class ToolExecutionComponent extends Container {
	...
	override invalidate(): void {
		super.invalidate();
		// Update padding from layout config (may have changed via settings)
		const padding = getOutputPaddingX();
		this.contentBox.setPaddingX(padding);
		this.contentText.setPaddingX(padding);
		this.updateDisplay();
	}
